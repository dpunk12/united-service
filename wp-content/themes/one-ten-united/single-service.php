...
<a href="<?php echo esc_url( home_url( '/book-appointment' ) ); ?>" class="btn btn--outline-white service-hero__btn">
...
<a href="tel:+17185550100" class="btn btn-white">
<?php esc_html_e( 'Call (718) 555-0100', 'otu' ); ?>
</a>
<a href="<?php echo esc_url( home_url( '/book-appointment' ) ); ?>" class="btn btn--outline-white">
<?php esc_html_e( 'Book Appointment', 'otu' ); ?>
</a>
</div>
</div>
