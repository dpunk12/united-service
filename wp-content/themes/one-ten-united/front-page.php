...
<section class="services-overview section" id="services" aria-label="<?php esc_attr_e( 'Services Overview', 'otu' ); ?>">
	<div class="container">
		...
		<div class="services-grid">
			...
			<!-- LLC Formation -->
			<a href="<?php echo esc_url( home_url( '/services/llc-formation' ) ); ?>" class="service-card">
			...
			<!-- EIN Application -->
			<a href="<?php echo esc_url( home_url( '/services/ein-application' ) ); ?>" class="service-card">
				<div class="service-card__icon">
			...
			<!-- Immigration Forms -->
			<a href="<?php echo esc_url( home_url( '/services/immigration-forms' ) ); ?>" class="service-card">
				<div class="service-card__icon">
			...
			<!-- Notary Services -->
			<a href="<?php echo esc_url( home_url( '/services/notary-services' ) ); ?>" class="service-card">
				<div class="service-card__icon">
			...
			<!-- Tax Services -->
			<a href="<?php echo esc_url( home_url( '/services/tax-services' ) ); ?>" class="service-card">
				<div class="service-card__icon">
			...
			<a href="<?php echo esc_url( home_url( '/services/document-preparation' ) ); ?>" class="service-card">
				<div class="service-card__icon">
